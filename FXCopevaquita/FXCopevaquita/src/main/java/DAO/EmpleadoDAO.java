...
public class EmpleadoDAO {
    ...
    // NUEVO METODO PARA AUTOCOMPLETAR LOS EMPLEADOS EN CBX
    public List<Empleado> obtenerListaAutocompletado(String pistaNombre) {
        ...
        try {
            String sql = "SELECT cedula, nombre, apellidos, sexo, estadoCivil,"
                    ...
                    + "FROM tbl_empleado where nombre like ?";
            ps = acceso.prepareStatement(sql);
            ps.setString(1, "%" + pistaNombre + "%");
            rs = ps.executeQuery();
